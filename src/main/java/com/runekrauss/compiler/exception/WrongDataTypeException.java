...
public class WrongDataTypeException extends CompilerException {
  /**
   * For which identifier was a data type applied incorrectly? Tracks all of the nodes in the AST
   * traversed by the parser.
   */
  ...
  /**
   * Identifies the row and column in which an identifier with an incorrect data type was used
   * within an operation.
   *
