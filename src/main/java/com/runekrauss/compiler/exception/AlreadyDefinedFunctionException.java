...
/**
 * This exception occurs when an attempt is made to call an already defined function. Note: Name
 * mangling is implemented, i.e. overloaded functions are permitted.
 *
 * @author Rune Krauss
 */
public class AlreadyDefinedFunctionException extends CompilerException {
   ...
   */
  public AlreadyDefinedFunctionException(final Token func) {
    super(func);
    id = func.getText();
  }
